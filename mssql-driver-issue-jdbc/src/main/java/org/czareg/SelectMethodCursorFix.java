...
public class SelectMethodCursorFix {

    public static void main(String[] args) throws Exception {
        String url = "jdbc:sqlserver://localhost:1433;databaseName=master;user=sa;password=YourStrong!Passw0rd;encrypt=false;selectMethod=cursor"; // FIX
