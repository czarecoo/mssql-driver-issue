...
public class ActivateMARSFix {

    public static void main(String[] args) throws Exception {
        String url = "jdbc:sqlserver://localhost:1433;databaseName=master;user=sa;password=YourStrong!Passw0rd;encrypt=false;multipleActiveResultSets=true"; // FIX?
